...
Já ao observarmos as variáveis qualitativas, a modalidade de ensino presencial domina fortemente sobre a educação a distância, com cerca de 77\% dos cursos. Enquanto isso, as categorias administrativas públicas concentram por volta de 6,7\% das instituições de ensino. Nessa variáveis é possível perceber que os intervalos de confiança de 95\% para estimar suas proporções são mais extensos que os das quantitativas, sendo (72.5957, 82.071) para modalidade de ensino Presencial e (2.6748, 10.6585) para categorías administrativas  Públicas.
