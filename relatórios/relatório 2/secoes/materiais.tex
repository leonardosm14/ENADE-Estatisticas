...
\begin{enumerate}
    ...
    Conforme o script do anexo A, o tamanho da amostra aleatória para essa variável será $n = 150$. 
    ...
    Conforme o script do anexo A, o tamanho da amostra aleatória para essa variável será $n = 300$. 
